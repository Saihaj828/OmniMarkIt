...
Revision ID: f345023f1d4f
Revises: 
Create Date: 2026-06-12 11:41:16.307559
"""
...
def upgrade() -> None:
    ...
    sa.Column('free_until', sa.DateTime(timezone=True), nullable=False),
    sa.Column('price_cents', sa.Integer(), nullable=False),
    sa.Column('created_at', sa.DateTime(timezone=True), nullable=False),
    sa.ForeignKeyConstraint(['session_id'], ['sessions.id'], ),
    ...
    op.create_table('recording_access',
    sa.Column('id', app.database.GUID(), nullable=False),
    sa.Column('recording_id', app.database.GUID(), nullable=False),
    sa.Column('user_id', app.database.GUID(), nullable=False),
    sa.Column('granted_by', app.database.GUID(), nullable=False),
    ...
    sa.ForeignKeyConstraint(['user_id'], ['users.id'], ),
    sa.PrimaryKeyConstraint('id'),
    sa.UniqueConstraint('recording_id', 'user_id', name='uq_recording_user')
    )
